...
ALLOWED_HOSTS = []
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-nr%x0(@g$0(nea$!aj@vv42n2w6yw9-g%@^k!r539!b5)1nhb@')

DEBUG = os.getenv('DEBUG', 'True') == 'True'

# Hosts allowed to serve the app. Set as comma-separated on Vercel.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'postgres',
        'USER': 'postgres.mxjeajtuevcgopaiqnco',
        'PASSWORD': 'Mwaka@0745971133',
